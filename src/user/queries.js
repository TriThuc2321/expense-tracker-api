...
const getByEmailQuery = 'SELECT * FROM "public"."user" WHERE email = $1';
...
module.exports = { getAllQuery, getByEmailQuery, checkEmailExistQuery, addUserQuery, updateUserQuery, deleteUserQuery };
