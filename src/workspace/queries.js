...
const getByUserIdQuery =
    'select * from public.workspace w where w."workspaceId" in (select w2."workspaceId" from public.workspaceDetail w2 where w2."userId" = $1)';
const addWorkspaceQuery = 'insert into public.workspace (workspaceId, workspaceName) values ($1, $2)';
const addWorkspaceDetailQuery = 'insert into public.workspaceDetail (workspaceId, userId) values ($1, $2)';
